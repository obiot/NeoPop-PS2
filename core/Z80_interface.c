...
inline void WrZ80(_u16 address, _u8 value)
{
	if (address <= 0x0FFF)
	{
...
inline void OutZ80(_u16 port, _u8 value)
{
#ifdef NEOPOP_DEBUG
...
inline void PatchZ80(register Z80 *R)
{
	// Empty
}

inline word LoopZ80(register Z80 *R)
{
	return INT_QUIT;
}
...
inline void Z80_nmi(void)
{
	IntZ80(&Z80_regs, INT_NMI);
}

inline void Z80_irq(void)
{
	Z80_regs.IFF |= IFF_1;
	IntZ80(&Z80_regs, INT_IRQ);
}

inline void Z80_reset(void)
{
	ResetZ80(&Z80_regs);
	Z80_regs.SP.W = 0;
}
...
inline _u16 Z80_getReg(_u8 reg)
{
	_u16* r = (_u16*)&Z80_regs;
	return r[reg];
}

inline void Z80_setReg(_u8 reg, _u16 value)
{
	_u16* r = (_u16*)&Z80_regs;
	r[reg] = value;
}
