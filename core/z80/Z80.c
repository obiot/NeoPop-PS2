...
static inline void CodesCB(register Z80 *R)
{
  register byte I;
...
static inline void CodesDDCB(register Z80 *R)
{
  register pair J;
  register byte I;
...
static inline void CodesFDCB(register Z80 *R)
{
  register pair J;
  register byte I;
...
static inline void CodesED(register Z80 *R)
{
  register byte I;
  register pair J;
...
static inline void CodesDD(register Z80 *R)
{
  register byte I;
  register pair J;
...
static inline void CodesFD(register Z80 *R)
{
  register byte I;
  register pair J;
